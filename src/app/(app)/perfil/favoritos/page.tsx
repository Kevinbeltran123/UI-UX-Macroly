...
type Combo = {
  id: string;
  name: string;
  items: Array<{ id: string; name: string; qty: number; portion: number; protein: number; carbs: number; fat: number; price: number; imageUrl: string | null; brand: string | null; weight: string | null; calories: number; categoryId: string | null; rating: number | null }>;
